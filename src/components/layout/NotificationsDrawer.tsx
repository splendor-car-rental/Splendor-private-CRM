    ...
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed inset-y-0 right-0 max-w-md w-full bg-zinc-950 border-l border-zinc-800 shadow-2xl flex flex-col z-10 animate-fade-in">
        ...
        <div className="p-5 border-b border-zinc-800 flex items-center justify-between bg-zinc-900/60">
          ...
          <button onClick={onClose} className="shrink-0 w-11 h-11 flex items-center justify-center rounded-lg text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 active:bg-zinc-800" aria-label="Close">
            <X className="w-5 h-5" />
          </button>
        </div>
