                  ...
                  <tr key={inv.id} className="hover:bg-zinc-900/40 transition-colors">
                    ...
                    <td className="p-4 text-end">
                      <WorkflowDocumentPreviewButton
                        ...
                        labelAr="معاينة الفاتورة الضريبية"
                        labelEn="Preview Tax Invoice"
                      />
                    </td>
                  </tr>
                ))}
