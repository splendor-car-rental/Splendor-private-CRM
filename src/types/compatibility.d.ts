...
declare module './index' {
  ...
  export interface SecurityDepositRecord { id: string; customerId: string; vehicleId?: string; vehicleId?: string; customerName?: string; vehicleName?: string; contractId?: string; reservationId?: string; amount: number; appliedAmount?: number; refundedAmount?: number; balance?: number; currentBalance?: number; totalDeductions?: number; deductions?: any[]; paymentMethod?: string; status: DepositLifecycleStatus; holdReleaseDueDate?: string; holdReleaseEligibleDate?: string; appliedReason?: string; refundDate?: string; returnDate?: string; releasedAt?: string; releasedBy?: string; transactionRef?: string; auditHistory?: any[]; notes?: string; createdAt?: string; updatedAt?: string; }
  ...
  export interface TrafficFine { id: string; vehicleId?: string; vehiclePlate?: string; customerId?: string; contractId?: string; reservationId?: string; date: string; amount: number; status: FineStatus; source: FineSource; referenceNumber?: string; violationDate?: string; violationTime?: string; ticketNumber?: string; description?: string; evidenceUrl?: string; createdAt?: string; updatedAt?: string; }
  ...
  export interface TelematicsAlert { id: string; vehicleId: string; contractId?: string; customerId?: string; type: string; title?: string; titleAr?: string; severity?: 'low' | 'medium' | 'high' | 'critical' | string; message?: string; timestamp: string; resolved?: boolean; resolvedAt?: string; resolvedBy?: string; metadata?: Record<string, unknown>; }
