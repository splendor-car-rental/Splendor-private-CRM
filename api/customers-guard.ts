...
// The generated Node 22 ESM bundle is the only supported Vercel entry for the
// legacy Express application. Importing ../server.js directly causes Node ESM
// to resolve the source file and crash on extensionless TypeScript-era imports.
// @ts-ignore -- generated by `npm run build` before Vercel function packaging.
...
function delegateToAuthoritativeCustomersRoute(req: Request, res: Response) {
  // The bundled API handler performs security-sensitive route matching before
  // Express sees the request, therefore define both URL and path explicitly.
